  ...
  return (
    <main className="page about-page">
      ...
      <section className="card about-card">
        ...
        <p>
          Для ближайших дат прогноз учитывает погоду: видимость, низкую облачность, ветер, влажность, давление и риск
          тумана. Пока точного прогноза погоды еще нет, сервис опирается на историю календарно близких дат и сезонные
          закономерности. Поэтому сделать прогноз можно на 365 дней вперед, а затем перепроверить прогноз, когда до
          поездки остается около двух недель.
        </p>
      </section>
      ...
      <section className="card about-card">
        ...
        <p>
          С момента запуска сервиса текущая логика предоставления прогнозов показывает точность около 80%, с учетом
    ...
    <main className="page">
      <section className="card predict-card">
        <div className="predict-card-header">
          <div>
            <div className="eyebrow">FLYFORECAST.RU</div>
            <h1>Когда самолет на Кунашир?</h1>
            <p className="lead">
      ...
      <section className="card service-about-card">
        ...
        <p>
          ...
          выполнялись или отменялись, и подробный прогноз погоды на 14 дней. На ближайшие две недели предсказание
          строится с учетом погоды, на более дальний период - по истории вылетов и сезонным
