    ...
    <main className="page about-page">
      <section className="card about-hero-card">
        <div className="about-hero-copy">
          ...
          <p className="lead">
            Здравствуйте! Меня зовут Владимир Зимин. Я магистрант AI Talent Hub (ИТМО) и предприниматель, занимаюсь
            развитием ИИ на Сахалине. Этот проект появился в рамках обучения в магистратуре и призван помочь жителям
            Кунашира планировать свои перелеты с острова в условиях нестабильной погоды.
          </p>
          <button className="secondary compact-button" onClick={onBack}>
            Назад к прогнозу
          </button>
